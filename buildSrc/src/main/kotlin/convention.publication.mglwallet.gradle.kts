        ...
        publications {
            register("release", MavenPublication::class) {
                ...
                pom {
                    ...
                    description.set("SDK for Android is a software development kit for fast integration of the mglwallet payment solutions right in your mobile application for Android.")
                    ...
                    developers {
                        developer {
                            ...
                            email.set("a.khrameev@it.mglwallet.com")
                        }
                        developer {
                            id.set("ecpit")
                            name.set("Roman Karpilenko")
                            email.set("r.karpilenko@it.mglwallet.com")
                        }
                    }
                    scm {
